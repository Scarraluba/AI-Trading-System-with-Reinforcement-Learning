...
public class VerticalLineTool extends AnalysisTool {
    ...
    public VerticalLineTool(double price, Color color, boolean isDotted, boolean isDraggable, String desc) {
...
//        }
    ...
    public boolean overlapsWith(AnalysisTool other) {
        if (other instanceof VerticalLineTool) {
            VerticalLineTool otherLine = (VerticalLineTool) other;
