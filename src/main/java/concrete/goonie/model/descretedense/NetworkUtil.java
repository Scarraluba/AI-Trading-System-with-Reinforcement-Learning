...
/**
 * Util class containing methods to build the neural com.lilium.snake.network and its configuration.
 *
 * @author mirza
 */
public final class NetworkUtil {
    /**
     * Number of neural com.lilium.snake.network inputs.
     */
    ...
    /**
     * Used to slow down com.lilium.snake.game step so that the user can see what is happening.
     *
